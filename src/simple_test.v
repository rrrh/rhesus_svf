...
module tt_um_simple_test (
    ...
    // Local wire declarations for power. Netgen LVS natively recognizes
    // these names as global power nets and will map them to the layout.
    wire vccd1;
    wire vssd1;
    ...
    // UNCONDITIONALLY bind power pins so Yosys groups them on the vccd1 net.
    (* keep = 1 *)
    r2r_dac_8bit u_dac (
        .vdd(vccd1),
        .vss(vssd1),
